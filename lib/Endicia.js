...
Endicia.prototype.changePassphrase = function changePassphrase(params) {
  params = params || {};
  var changePassphraseRequestPayload = {
    xml: {
      '@version': '1.0',
      '@encoding': 'utf-8',
      standalone: true
  ...
  var xml = xmlbuilder.create(changePassphraseRequestPayload).end({pretty: true});
  return this.sendRequest(this.endpoint + '/ChangePassPhraseXML?changePassPhraseRequestXML=' + xml);
};

Endicia.prototype.getChallengeQuestion = function getChallengeQuestion(params) {
  params = params || {};
  var getChallengeQuestionRequestPayload = {
    xml: {
      '@version': '1.0',
      '@encoding': 'utf-8',
      standalone: true
  ...
  var xml = xmlbuilder.create(getChallengeQuestionRequestPayload).end({pretty: true});
  return this.sendRequest(this.endpoint + '/GetChallengeQuestionXML?challengeQuestionRequestXML=' + xml);
};

Endicia.prototype.resetSuspendedAccount = function resetSuspendedAccount(params) {
  params = params || {};
  var resetSuspendedAccountRequestPayload = {
    xml: {
      '@version': '1.0',
      '@encoding': 'utf-8',
      standalone: true
  ...
  var xml = xmlbuilder.create(resetSuspendedAccountRequestPayload).end({pretty: true});
  return this.sendRequest(this.endpoint + '/ResetSuspendedAccountXML?resetSuspendedAccountRequestXML=' + xml);
};
